...
public class Main {
    ...
    public static HashMap<String, Integer> magSort(HashMap<String, Integer> shopCart) {
        ...
        HashMap<String, Integer> correctShopList = new HashMap<>();
        for (Map.Entry a : shopCart.entrySet()) {
            if ((Integer)a.getValue() <= 300) {
                correctShopList.put((String) a.getKey(), (Integer) a.getValue());
            }
        }
